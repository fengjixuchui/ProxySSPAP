...
// Basic
typedef NTSTATUS (NTAPI SamFreeMemory)(
	_In_ PVOID Buffer
);

typedef NTSTATUS (NTAPI SamCloseHandle)(
	_In_ SAM_HANDLE SamHandle
);

typedef _Check_return_ NTSTATUS(NTAPI SamSetSecurityObject)(
	_In_ SAM_HANDLE ObjectHandle,
	_In_ SECURITY_INFORMATION SecurityInformation,
	_In_ PSECURITY_DESCRIPTOR SecurityDescriptor
);

typedef _Check_return_ NTSTATUS(NTAPI SamQuerySecurityObject)(
	_In_ SAM_HANDLE ObjectHandle,
	_In_ SECURITY_INFORMATION SecurityInformation,
	_Outptr_ PSECURITY_DESCRIPTOR *SecurityDescriptor
);

typedef _Check_return_ NTSTATUS(NTAPI SamRidToSid)(
	_In_ SAM_HANDLE ObjectHandle,
	_In_ ULONG Rid,
	_Outptr_ PSID *Sid
);
...
typedef _Check_return_ NTSTATUS (NTAPI SamConnect) (
...
typedef _Check_return_ NTSTATUS (NTAPI SamShutdownSamServer)(
...
typedef _Check_return_ NTSTATUS(NTAPI SamLookupDomainInSamServer)(
	_In_ SAM_HANDLE ServerHandle,
	_In_ PUNICODE_STRING Name,
	_Outptr_ PSID *DomainId
);

typedef _Check_return_ NTSTATUS(NTAPI SamEnumerateDomainsInSamServer)(
	_In_ SAM_HANDLE ServerHandle,
...
typedef _Check_return_ NTSTATUS (NTAPI SamOpenDomain)(
	_In_ SAM_HANDLE ServerHandle,
	_In_ ACCESS_MASK DesiredAccess,
	_In_ PSID DomainId,
...
typedef _Check_return_ NTSTATUS(NTAPI SamQueryInformationDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ DOMAIN_INFORMATION_CLASS DomainInformationClass,
	_Outptr_ PVOID *Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamSetInformationDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ DOMAIN_INFORMATION_CLASS DomainInformationClass,
	_In_ PVOID DomainInformation
);

typedef _Check_return_ NTSTATUS(NTAPI SamLookupNamesInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ ULONG Count,
...
typedef _Check_return_ NTSTATUS(NTAPI SamLookupIdsInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ ULONG Count,
...
typedef _Check_return_ NTSTATUS(NTAPI SamRemoveMemberFromForeignDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ PSID MemberId
);

typedef _Check_return_ NTSTATUS(NTAPI SamQueryLocalizableAccountsInDomain)(
...
typedef _Check_return_ NTSTATUS(NTAPI SamEnumerateGroupsInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_Inout_ PSAM_ENUMERATE_HANDLE EnumerationContext,
...
typedef _Check_return_ NTSTATUS(NTAPI SamCreateGroupInDomain)(
	_In_ SAM_HANDLE DomainHandle,
...
typedef _Check_return_ NTSTATUS(NTAPI SamOpenGroup)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ ACCESS_MASK DesiredAccess,
	_In_ ULONG GroupId,
	_Out_ PSAM_HANDLE GroupHandle
...
typedef _Check_return_ NTSTATUS(NTAPI SamDeleteGroup)(
	_In_ SAM_HANDLE GroupHandle
);

typedef _Check_return_ NTSTATUS(NTAPI SamQueryInformationGroup)(
	_In_ SAM_HANDLE GroupHandle,
	_In_ GROUP_INFORMATION_CLASS GroupInformationClass,
	_Outptr_ PVOID *Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamSetInformationGroup)(
	_In_ SAM_HANDLE GroupHandle,
	_In_ GROUP_INFORMATION_CLASS GroupInformationClass,
	_In_ PVOID Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamAddMemberToGroup)(
	_In_ SAM_HANDLE GroupHandle,
	_In_ ULONG MemberId,
	_In_ ULONG Attributes
);

typedef _Check_return_ NTSTATUS(NTAPI SamRemoveMemberFromGroup)(
	_In_ SAM_HANDLE GroupHandle,
	_In_ ULONG MemberId
);

typedef _Check_return_ NTSTATUS(NTAPI SamGetMembersInGroup)(
	_In_ SAM_HANDLE GroupHandle,
...
typedef _Check_return_ NTSTATUS(NTAPI SamSetMemberAttributesOfGroup)(
	_In_ SAM_HANDLE GroupHandle,
	_In_ ULONG MemberId,
	_In_ ULONG Attributes
);
...
typedef _Check_return_ NTSTATUS(NTAPI SamEnumerateAliasesInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_Inout_ PSAM_ENUMERATE_HANDLE EnumerationContext,
...
typedef _Check_return_ NTSTATUS(NTAPI SamCreateAliasInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ PUNICODE_STRING AccountName,
	_In_ ACCESS_MASK DesiredAccess,
...
typedef _Check_return_ NTSTATUS(NTAPI SamOpenAlias)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ ACCESS_MASK DesiredAccess,
	_In_ ULONG AliasId,
	_Out_ PSAM_HANDLE AliasHandle
...
typedef _Check_return_ NTSTATUS(NTAPI SamDeleteAlias)(
	_In_ SAM_HANDLE AliasHandle
);

typedef _Check_return_ NTSTATUS(NTAPI SamQueryInformationAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_ ALIAS_INFORMATION_CLASS AliasInformationClass,
	_Outptr_ PVOID *Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamSetInformationAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_ ALIAS_INFORMATION_CLASS AliasInformationClass,
	_In_ PVOID Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamAddMemberToAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_ PSID MemberId
);

typedef _Check_return_ NTSTATUS(NTAPI SamAddMultipleMembersToAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_reads_(MemberCount) PSID *MemberIds,
	_In_ ULONG MemberCount
);

typedef _Check_return_ NTSTATUS(NTAPI SamRemoveMemberFromAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_ PSID MemberId
);

typedef _Check_return_ NTSTATUS(NTAPI SamRemoveMultipleMembersFromAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_In_reads_(MemberCount) PSID *MemberIds,
	_In_ ULONG MemberCount
);

typedef _Check_return_ NTSTATUS(NTAPI SamGetMembersInAlias)(
	_In_ SAM_HANDLE AliasHandle,
	_Out_ _Deref_post_count_(*MemberCount) PSID **MemberIds,
	_Out_ PULONG MemberCount
);

typedef _Check_return_ NTSTATUS(NTAPI SamGetAliasMembership)(
	_In_ SAM_HANDLE DomainHandle,
...
typedef _Check_return_ NTSTATUS(NTAPI SamEnumerateUsersInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_Inout_ PSAM_ENUMERATE_HANDLE EnumerationContext,
...
typedef _Check_return_ NTSTATUS(NTAPI SamCreateUserInDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ PUNICODE_STRING AccountName,
	_In_ ACCESS_MASK DesiredAccess,
...
typedef _Check_return_ NTSTATUS(NTAPI SamCreateUser2InDomain)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ PUNICODE_STRING AccountName,
...
typedef _Check_return_ NTSTATUS(NTAPI SamOpenUser)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ ACCESS_MASK DesiredAccess,
	_In_ ULONG UserId,
	_Out_ PSAM_HANDLE UserHandle
...
typedef _Check_return_ NTSTATUS(NTAPI SamDeleteUser)(
	_In_ SAM_HANDLE UserHandle
);

typedef _Check_return_ NTSTATUS(NTAPI SamQueryInformationUser)(
	_In_ SAM_HANDLE UserHandle,
	_In_ USER_INFORMATION_CLASS UserInformationClass,
	_Outptr_ PVOID *Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamSetInformationUser)(
	_In_ SAM_HANDLE UserHandle,
	_In_ USER_INFORMATION_CLASS UserInformationClass,
	_In_ PVOID Buffer
);

typedef _Check_return_ NTSTATUS(NTAPI SamGetGroupsForUser)(
	_In_ SAM_HANDLE UserHandle,
	_Out_ _Deref_post_count_(*MembershipCount) PGROUP_MEMBERSHIP *Groups,
	_Out_ PULONG MembershipCount
);

typedef _Check_return_ NTSTATUS(NTAPI SamChangePasswordUser)(
	_In_ SAM_HANDLE UserHandle,
	_In_ PUNICODE_STRING OldPassword,
	_In_ PUNICODE_STRING NewPassword
);

typedef _Check_return_ NTSTATUS(NTAPI SamChangePasswordUser2)(
...
typedef _Check_return_ NTSTATUS(NTAPI SamChangePasswordUser3)(
	_In_ PUNICODE_STRING ServerName,
	_In_ PUNICODE_STRING UserName,
	_In_ PUNICODE_STRING OldPassword,
	_In_ PUNICODE_STRING NewPassword,
...
typedef _Check_return_ NTSTATUS(NTAPI SamQueryDisplayInformation)(
	_In_ SAM_HANDLE DomainHandle,
...
typedef _Check_return_ NTSTATUS(NTAPI SamGetDisplayEnumerationIndex)(
	_In_ SAM_HANDLE DomainHandle,
	_In_ DOMAIN_DISPLAY_INFORMATION DisplayInformation,
...
typedef _Check_return_ NTSTATUS(NTAPI SamRegisterObjectChangeNotification)(
	_In_ SECURITY_DB_OBJECT_TYPE ObjectType,
	_In_ HANDLE NotificationEventHandle
);

typedef _Check_return_ NTSTATUS(NTAPI SamUnregisterObjectChangeNotification)(
	_In_ SECURITY_DB_OBJECT_TYPE ObjectType,
	_In_ HANDLE NotificationEventHandle
);
...
typedef _Check_return_ NTSTATUS(NTAPI SamGetCompatibilityMode)(
	_In_ SAM_HANDLE ObjectHandle,
	_Out_ ULONG *Mode
);
...
typedef _Check_return_ NTSTATUS(NTAPI SamValidatePassword)(
	_In_opt_ PUNICODE_STRING ServerName,
...
typedef _Check_return_ NTSTATUS(NTAPI SamPerformGenericOperation)(
...
/// FUNCTION POINTERS
typedef SamConnect					*PSAM_CONNECT;
typedef SamLookupDomainInSamServer  *PSAM_LOOKUP_DOMAIN_IN_SERVER;
typedef SamOpenDomain				*PSAM_OPEN_DOMAIN;
typedef SamEnumerateUsersInDomain	*PSAM_ENUMERATE_USERS_IN_DOMAIN;
typedef SamOpenUser					*PSAM_OPEN_USER;
typedef SamQueryInformationUser		*PSAM_QUERY_INFO_USER;
typedef	SamRidToSid					*PSAM_RID_TO_SID;
typedef SamOpenGroup				*PSAM_OPEN_GROUP;
typedef SamGetGroupsForUser			*PSAM_GET_GROUPS_FOR_USER;
typedef SamFreeMemory				*PSAM_FREE_MEMORY;
typedef SamCloseHandle				*PSAM_CLOSE_HANDLE;
#endif
